    ...
    return (
        <Tabs defaultValue="swap" className="w-full min-h-[100vh]">
            <TabsList className="grid w-full grid-cols-3 mb-4">
                <TabsTrigger value="swap" className="flex items-center justify-center bg-gray-800 bg-opacity-50 text-white">
                    <ArrowRightLeft className="mr-2 h-4 w-4" />
                    Swap
                </TabsTrigger>
                <TabsTrigger value="stake" className="flex items-center justify-center bg-gray-800 bg-opacity-50 text-white">
                    <Wallet className="mr-2 h-4 w-4" />
                    Stake
                </TabsTrigger>
                <TabsTrigger value="dashboard" className="flex items-center justify-center bg-gray-800 bg-opacity-50 text-white">
            ...
            <TabsContent value="stake">
                <Card className="bg-gray-800 bg-opacity-30 backdrop-blur-lg text-white border-none">
                    ...
                    <CardContent>
                        <StakeForm stakeAmount={stakeAmount} setStakeAmount={setStakeAmount} />
                    </CardContent>
                    <CardFooter>
                        <Button
                            ...
                            onClick={async () => {
                                ...
                                const tx = await stake(connection, wallet as AnchorWallet, parseFloat(stakeAmount));
